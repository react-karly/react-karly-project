    ...
    <div>
      ...
      <div className={styles['add-cart-container']}>
        ...
        <div className={styles['product-amount-wrapper']}>
          <span className={styles['product-name']}>[풀무원] 탱탱쫄면 (4개입)</span>
          <div className={styles['price-counter-wrapper']}>
          <span className={styles['product-price']}>4,980원</span>
          <div className={styles['counter-box']}>
       
            
            <button onClick={minus} className={styles['minus-btn']} type="button">−</button>
            <span className={styles['counter-value']}>0</span>
            <button onClick={plus} className={styles['plus-btn']} type="button">+</button>
        ...
        <div className={styles['total-price-wrapper']}>
         ...
         <span className={styles['saving-price']}>구매 시 5원 적립</span>
       </div>
      
          <button onClick={cancle} className={styles['cancle-btn']} type="button">취소</button>
